...
const About = () => {
  return (
    <section id="About" className='relative min-h-screen'>
      ...
      <h1 className='text-8xl sticky -top-10 z-10 font-semibold px-20 py-44'>A<span className='text-7xl'>BOUT</span> M<span className='text-7xl'>E</span></h1>
      <div className='absolute top-96 left-96 transform'>
        ...
        <div className='flex flex-col text-2xl justify-center w-[75%] m-auto'>
