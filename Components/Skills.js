...
const Skills = () => {
    return (
        <section id="Skills" className="relative dark:text-white text-dark  min-h-screen">
            {/* Titles */}
            ...
            <div className="skills-container container items-center transition-all duration-300 mx-auto flex flex-wrap gap-20 justify-center ">
                ...
                <Image unoptimized priority title='HTML' src={html} alt="HTML" className='hover:scale-[1.2] transition-transform duration-300' width={200} height={200} />
                <Image unoptimized priority title='CSS' src={css} alt="CSS" className='hover:scale-[1.2] transition-transform duration-300' width={200} height={200} />
                <Image unoptimized priority title='JavaScript' src={js} alt="JS" className='hover:scale-[1.2] transition-transform duration-300' width={200} height={200} />
                <Image unoptimized priority title='Bootstrap' src={bootstrap} alt="Bootstrap" className='hover:scale-[1.2] transition-transform duration-300' width={200} height={200} />
                <Image unoptimized priority title='TailwindCSS' src={tailwindcss} alt="TailwindCSS" className='hover:scale-[1.2] transition-transform duration-300' width={200} height={200} />
                <Image unoptimized priority title='React.Js' src={reactjs} alt="React.Js" className='hover:scale-[1.2] transition-transform duration-300' width={200} height={200} />
                <Image unoptimized priority title='Next.Js' src={nextjs} alt="Next.Js" className='hover:scale-[1.2] dark:invert transition-transform duration-300' width={200} height={200} />
                <Image unoptimized priority title='Django' src={django} alt="Django" className='hover:scale-[1.2] transition-transform duration-300' width={200} height={200} />
                <Image unoptimized priority title='MongoDB' src={mongodb} alt="MongoDB" className='hover:scale-[1.2] transition-transform duration-300' width={200} height={200} />
                <Image unoptimized priority title='SQL' src={sql} alt="SQL" className='hover:scale-[1.2] transition-transform duration-300' width={200} height={200} />
                <Image unoptimized priority title='Firebase' src={firebase} alt="Firebase" className='hover:scale-[1.2] transition-transform duration-300' width={200} height={200} />
                <Image unoptimized priority title='Java' src={java} alt="Java" className='hover:scale-[1.2] transition-transform duration-300' width={200} height={200} />
                <Image unoptimized priority title='Python' src={python} alt="Python" className='hover:scale-[1.2] transition-transform duration-300' width={200} height={200} />
            </div>
