  ...
  return (
    <section id='/' className='lg:min-h-screen'>
      <div className="flex flex-col lg:flex-row items-center justify-between mt-32 lg:m-56">
        ...
        <div className="bg-purple-400 lg:block hidden absolute rounded-full w-52 h-32 blur-[150px]"></div>
        <div className="bg-pink-600 lg:block hidden absolute lg:right-0 right-32 lg:bottom-0 bottom-0 lg:top-0 rounded-full w-36 lg:w-64 h-16 lg:h-24 blur-[80px] lg:blur-[200px]"></div>
        ...
        <div className="gap-5 flex lg:mt-0 mt-20 lg:flex-col items-center justify-center">
          <Link href={'https://discord.gg/wbfb66EZDU'} target='_blank' className="dark:fill-white hover:scale-[1.2] transition-transform duration-200">
            <div className="dark:bg-[#13071f] shadow-[0px_0px_20px_#7b2cbf] flex justify-center items-center h-10 w-10 p-2  rounded-full">
              <svg xmlns="http://www.w3.org/2000/svg" className='h-10 w-10' viewBox="0 0 640 512"><path d="M524.5 69.8a1.5 1.5 0 0 0 -.8-.7A485.1 485.1 0 0 0 404.1 32a1.8 1.8 0 0 0 -1.9 .9 337.5 337.5 0 0 0 -14.9 30.6 447.8 447.8 0 0 0 -134.4 0 309.5 309.5 0 0 0 -15.1-30.6 1.9 1.9 0 0 0 -1.9-.9A483.7 483.7 0 0 0 116.1 69.1a1.7 1.7 0 0 0 -.8 .7C39.1 183.7 18.2 294.7 28.4 404.4a2 2 0 0 0 .8 1.4A487.7 487.7 0 0 0 176 479.9a1.9 1.9 0 0 0 2.1-.7A348.2 348.2 0 0 0 208.1 430.4a1.9 1.9 0 0 0 -1-2.6 321.2 321.2 0 0 1 -45.9-21.9 1.9 1.9 0 0 1 -.2-3.1c3.1-2.3 6.2-4.7 9.1-7.1a1.8 1.8 0 0 1 1.9-.3c96.2 43.9 200.4 43.9 295.5 0a1.8 1.8 0 0 1 1.9 .2c2.9 2.4 6 4.9 9.1 7.2a1.9 1.9 0 0 1 -.2 3.1 301.4 301.4 0 0 1 -45.9 21.8 1.9 1.9 0 0 0 -1 2.6 391.1 391.1 0 0 0 30 48.8 1.9 1.9 0 0 0 2.1 .7A486 486 0 0 0 610.7 405.7a1.9 1.9 0 0 0 .8-1.4C623.7 277.6 590.9 167.5 524.5 69.8zM222.5 337.6c-29 0-52.8-26.6-52.8-59.2S193.1 219.1 222.5 219.1c29.7 0 53.3 26.8 52.8 59.2C275.3 311 251.9 337.6 222.5 337.6zm195.4 0c-29 0-52.8-26.6-52.8-59.2S388.4 219.1 417.9 219.1c29.7 0 53.3 26.8 52.8 59.2C470.7 311 447.5 337.6 417.9 337.6z" /></svg>
            </div>
          </Link>
          <Link href={'https://www.instagram.com/shariq.02_/'} target='_blank' className="dark:fill-white hover:scale-[1.2] transition-transform duration-200">
            <div className="dark:bg-[#13071f] shadow-[0px_0px_20px_purple] flex justify-center items-center h-10 w-10 p-2  rounded-full">
              <svg xmlns="http://www.w3.org/2000/svg" className='h-10 w-10' viewBox="0 0 448 512"><path d="M224.1 141c-63.6 0-114.9 51.3-114.9 114.9s51.3 114.9 114.9 114.9S339 319.5 339 255.9 287.7 141 224.1 141zm0 189.6c-41.1 0-74.7-33.5-74.7-74.7s33.5-74.7 74.7-74.7 74.7 33.5 74.7 74.7-33.6 74.7-74.7 74.7zm146.4-194.3c0 14.9-12 26.8-26.8 26.8-14.9 0-26.8-12-26.8-26.8s12-26.8 26.8-26.8 26.8 12 26.8 26.8zm76.1 27.2c-1.7-35.9-9.9-67.7-36.2-93.9-26.2-26.2-58-34.4-93.9-36.2-37-2.1-147.9-2.1-184.9 0-35.8 1.7-67.6 9.9-93.9 36.1s-34.4 58-36.2 93.9c-2.1 37-2.1 147.9 0 184.9 1.7 35.9 9.9 67.7 36.2 93.9s58 34.4 93.9 36.2c37 2.1 147.9 2.1 184.9 0 35.9-1.7 67.7-9.9 93.9-36.2 26.2-26.2 34.4-58 36.2-93.9 2.1-37 2.1-147.8 0-184.8zM398.8 388c-7.8 19.6-22.9 34.7-42.6 42.6-29.5 11.7-99.5 9-132.1 9s-102.7 2.6-132.1-9c-19.6-7.8-34.7-22.9-42.6-42.6-11.7-29.5-9-99.5-9-132.1s-2.6-102.7 9-132.1c7.8-19.6 22.9-34.7 42.6-42.6 29.5-11.7 99.5-9 132.1-9s102.7-2.6 132.1 9c19.6 7.8 34.7 22.9 42.6 42.6 11.7 29.5 9 99.5 9 132.1s2.7 102.7-9 132.1z" /></svg>
            </div>
          </Link>
          <Link href={'https://www.linkedin.com/in/mohd-shariq-sheikh/'} target='_blank' className="dark:fill-white hover:scale-[1.2] transition-transform duration-200">
            <div className="dark:bg-[#13071f] shadow-[0px_0px_20px_blue] flex justify-center items-center h-10 w-10 p-2  rounded-full">
          ...
          <Link href={'mailto:shariqmohd737@gmail.com'} target='_blank' className="dark:fill-white hover:scale-[1.2] transition-transform duration-200">
            <div className="dark:bg-[#13071f] shadow-[0px_0px_20px_cyan] flex justify-center items-center h-10 w-10 p-2  rounded-full">
              <svg xmlns="http://www.w3.org/2000/svg" className='h-10 w-10' viewBox="0 0 512 512"><path d="M48 64C21.5 64 0 85.5 0 112c0 15.1 7.1 29.3 19.2 38.4
